...
Crie um aplicativo web chamado DALLARMI FLUXO DIGITAL — um portal para um laboratório de prótese dentária receber e acompanhar ordens de serviço enviadas pelas clínicas parceiras. TODA a interface deve ser em português do Brasil.
